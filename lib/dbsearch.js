...
function getGlobalAndPluginData(callback) {
	async.parallel({
		...
		results.plugin.topicsIndexed = results.plugin.topicsIndexed > results.global.topicCount ? results.global.topicCount : results.plugin.topicsIndexed;
		results.plugin.postsIndexed = results.plugin.postsIndexed > results.global.postCount ? results.global.postCount : results.plugin.postsIndexed;
